#+TITLE: Emacs Configuration for Guix
...
This is disabled here since it seems that it is properly managed by my .dotfiles / kreved  / rde.
...
#+begin_src emacs-lisp
  ...
  ;;(set-frame-font "Iosevka Oblique" t t)
  (custom-set-faces
   '(default ((t (:height 140 :family "Iosevka Oblique")))))
...
#+begin_src emacs-lisp
  ...
  (ng/leader-key-def
    ...
    "fde" '((lambda () (interactive) (find-file (expand-file-name "~/.dotfiles/home/yggdrasil/files/config/emacs/Emacs.org"))) :which-key "edit config")
    "fdE" '((lambda () (interactive) (ng/org-file-show-headings "~/.dotfiles/home/yggdrasil/files/config/emacs/Emacs.org")) :which-key "edit config")
...
A workflows file, tangled with org-mode.

#+begin_src emacs-lisp

  (load-file "~/.config/emacs/ng-workflow.el")
