    ...
    (org-roam-capture-templates
      '(("m" "main" plain
        ...
        ("a" "article" plain "%?"
         ...
         :immediate-finish t
         :unnarrowed t)
        ("s" "Slipbox" entry  (file "docs/roam/inbox.org")
       "* %?\n")))
...
(use-package org-roam-bibtex
  ...
  (setq bibtex-completion-library-path
        (concat (getenv "HOME") "/docs/resources"))
  (setq bibtex-completion-notes-path
        (concat (getenv "HOME") "/docs/roam")))
...
(use-package citar
  :no-require
  :custom
  (org-cite-global-bibliography '("~/docs/roam/biblio.bib"))
