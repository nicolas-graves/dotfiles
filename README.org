...
The generation of =channels.scm= is temporarily included in the =make home= call. It relies on the function =channels-content=, with the optional abiblity to pin or freeze commits.
