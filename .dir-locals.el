...
((nil
 ...
 (scheme-mode
  ...
  ((indent-tabs-mode . nil)
   ...
   (eval . (modify-syntax-entry ?$ "'"))
   (eval . (modify-syntax-entry ?+ "'"))
   (eval . (add-to-list 'geiser-guile-load-path "/home/graves/.local/src/guix"))
   (eval . (add-to-list 'geiser-guile-load-path "/home/graves/.local/src/nonguix"))
   (eval . (add-to-list 'geiser-guile-load-path "/home/graves/.local/src/rde"))))
