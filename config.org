...
#+begin_src scheme :tangle (if (string= system-name "Precision-3571") ".guix-channel" "no") :noweb yes
;; -*- mode: scheme; -*-

(channel
 (version 0)
 (url "https://git.sr.ht/ngraves/dotfiles")
 (dependencies
  <<base-channels>>
  (channel
   (name guix)
...
#+begin_src scheme :tangle (if (string= system-name "20AMS6GD00") ".guix-channel" "no") :noweb yes
;; -*- mode: scheme; -*-
...
#+begin_src scheme :tangle (if (string= system-name "2325K55") ".guix-channel" "no") :noweb yes
;; -*- mode: scheme; -*-
...
#+begin_src scheme :tangle (if (string= system-name "W54_55SU1,SUW") ".guix-channel" "no") :noweb yes
