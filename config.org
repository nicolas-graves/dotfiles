          ...
          (list
           (simple-service
            ...
            `(("channels.scm" ,(local-file "../.config/guix/channels.scm"))
              ("guix-sources" ,(local-file "../areas/informatique/guix"
                                           #:recursive? #t))
              ("nonguix-sources" ,(local-file "../projects/src/nonguix"
                                              #:recursive? #t))
              ("rde-sources" ,(local-file "../areas/informatique/rde"
                                          #:recursive? #t))
...
(define %main-features
  (list
   ...
   (feature-emacs-guix
    #:guix-directory "/home/graves/areas/informatique/guix")
   ...
   (feature-emacs-guix-development
    #:guix-load-path "/home/graves/areas/informatique/guix"
    #:other-guile-load-paths (list "/home/graves/areas/informatique/rde")
