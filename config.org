          ...
          (list
           (simple-service
            ...
            `(("channels.scm" ,(local-file "../.config/guix/channels.scm"))
              ("guix-sources" ,(local-file "../spheres/informatique/guix"
                                           #:recursive? #t))
              ("nonguix-sources" ,(local-file "../projects/src/nonguix"
                                              #:recursive? #t))
              ("rde-sources" ,(local-file "../spheres/informatique/rde"
                                          #:recursive? #t))
...
(define %main-features
  (list
   ...
   (feature-emacs-guix
    #:guix-directory "/home/graves/spheres/informatique/guix")
   ...
   (feature-emacs-guix-development
    #:guix-load-path "/home/graves/spheres/informatique/guix"
    #:other-guile-load-paths (list "/home/graves/spheres/informatique/rde")
