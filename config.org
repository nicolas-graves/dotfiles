...
(ng-feature-sway
 ...
 `((bindsym
    ...
    (($mod+Shift+s exec "grim -g \"$(slurp)\" - | swappy -f -")
     ...
     ($mod+p exec ~/spheres/info/dotfiles/home/scripts/menu_pass)
     ($mod+w exec chromium)
     ($mod+Shift+w exec chromium --incognito)
     ;; ($mod+Shift+o exec emacsclient -c -e "'(dired /home/graves)'")
     ($mod+m exec ~/spheres/info/dotfiles/home/scripts/playm)
...
(define %main-features
  (list
    ...
    (list
     ...
     (simple-service
      ...
      `(("MENU" . ,(file-append rofi "/bin/rofi -dmenu"))
        ...
        ("PATH" . (string-append
                   "${PATH}:"
                   "${HOME}/spheres/info/dotfiles/home/scripts:"
                   "${HOME}/spheres/info/dotfiles/home/scripts/statusbar:"
                   "${HOME}/spheres/info/dotfiles/home/scripts/cron:"
        ...
        ("LESSHISTFILE" . "-")
        ("SUDOASKPASS" . "${HOME}/spheres/info/dotfiles/home/scripts/menuaskpass")))
     ...
     (simple-service
      ...
      (home-bash-extension
       (bashrc
        '("source /home/graves/spheres/info/dotfiles/home/config/shell/aliasrc"))))
     (simple-service
      'zsh-aliases
   ...
   (feature-emacs-elfeed
    #:opml-feeds-file "~/spheres/info/dotfiles/home/config/elfeed.opml")
   ...
   (feature-emacs-guix-development
    ...
    #:snippets-path "~/spheres/info/dotfiles/home/config/guix/snippets/*.eld")
