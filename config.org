...
;; NOTE: This file is generated from ~/spheres/info/dots/config.org.  Please see commentary there.
...
(define %msmtp-provider-settings
  (acons 'ovh-pro1 '((host . "pro1.mail.ovh.net")
                    (port . 587))
...
(define %%isync-serializers
  (acons 'ovh-pro1 (ovh-pro-isync-settings "1")
          %%%isync-serializers))
      ...
      (defun refresh-gen-biblio ()
        ...
        (with-temp-buffer
         (let ((biblio-synchronous t))
           (mapcar 'biblio-doi-insert-bibtex
                   (cl-set-exclusive-or
