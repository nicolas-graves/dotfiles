           ...
           (simple-service
            ...
            `(("channels.scm" ,(local-file "../.config/guix/channels.scm"))
              ("guix-sources" ,(local-file "../.local/src/guix"
                                           #:recursive? #t))
              ("nonguix-sources" ,(local-file "../.local/src/nonguix"
                                              #:recursive? #t))
              ("rde-sources" ,(local-file "../.local/src/rde"
                                          #:recursive? #t))
              ("dotfiles-sources" ,(local-file "../.local/src/dotfiles"
                                           #:recursive? #t)))))
...
(define-public (pkgs #:rest lst)
  (map specification->package+output lst))

(define-public (pkgs-vanilla #:rest lst)
