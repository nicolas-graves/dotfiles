...
#+begin_src emacs-lisp :eval yes :export none
(setq devices
      '((Precision-3571 .
         ((efi         . /dev/nvme0n1p1)
          (swap        . /dev/nvme0n1p2)
...
#+begin_src scheme :tangle ./system/yggdrasil.scm :noweb yes
...
(operating-system
  ...
  (swap-devices (list (swap-space (target "<<lookup(var='swap)>>"))))
...
(define imported:cow-store-service
